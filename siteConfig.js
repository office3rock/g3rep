module.exports = {
  siteUrl: "https://g3rep.com", // Site domain. Do not include a trailing slash!

  postsPerPage: 12, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

  siteTitleMeta: "g3rep", // This allows an alternative site title for meta data for pages.
  siteDescriptionMeta:
    "g3rep", // This allows an alternative site description for meta data for pages.

  shareImageWidth: 1000, // Change to the width of your default share image
  shareImageHeight: 523, // Change to the height of your default share image

  shortTitle: "g3rep", // Used for App manifest e.g. Mobile Home Screen
  siteIcon: "favicon.png", // Logo in /static dir used for SEO, RSS, and App manifest
  backgroundColor: "#e9e9e9", // Used for Offline Manifest
  themeColor: "#15171A", // Used for Offline Manifest
  apiUrl: "https://reshet.jetdomains.co.il/g3rep",
  subscribeWidget: {
    visible: false,
    title: "g3rep",
  ...
  footer: {
    ...
    navigation: [
      ...
      {
        label: "Sitemap",
        url: "https://g3rep.com/sitemap.xml",
      },
